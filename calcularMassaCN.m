...
function [X, Xd, R] = calcularMassaCN(Xe, X0, dt, nt, R0, nr, Def, hm, f)
...
%Umidade média adimensional, na seção, no último tempo
Xj = mean(X(:,nt)) ;
Xd(nt) = (Xj - Xe) / (X0 - Xe) ;

%Cálculo do raio para o último instante de tempo devido ao encolhimento da banana
